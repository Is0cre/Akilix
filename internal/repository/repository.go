...
func (i Item) Validate() error {
	if i.ID == "" || strings.TrimSpace(i.Name) == "" || (i.Purpose != "base" && i.Purpose != "desktop" && i.Purpose != "boot" && i.Purpose != "security") || (i.Tier != "release" && i.Tier != "obs") || (i.Status != "approved" && i.Status != "candidate") {
