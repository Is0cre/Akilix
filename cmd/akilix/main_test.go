...
func TestRepositoryListExposesApprovedImageSources(t *testing.T) {
	...
	want := map[string]bool{"leap-16-oss": true, "x11-wayland-leap-16": true, "base-system-leap-16": true, "m17n-fonts-leap-16": true, "security-tools-leap-16": true, "filesystems-leap-16": true, "network-utilities-leap-16": true}
