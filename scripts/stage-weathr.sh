...
base_url=${AKILIX_WEATHR_MIRROR:-https://github.com/Veirt/weathr/releases/download/v${version}}
source_url=${AKILIX_WEATHR_SOURCE_MIRROR:-https://raw.githubusercontent.com/Veirt/weathr/v${version}}
